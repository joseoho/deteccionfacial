        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-xl shadow-lg p-6">
                <h2 class="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                    <i class="fas fa-file-alt text-indigo-600 mr-3"></i>Informe de Asistencias - Personal
                </h2>

                <form action="{{ route('ReporteIngresosxEmpleado.store') }}" method="POST">
                    @csrf
        ...
        <div>
            <div class="bg-gradient-to-br from-indigo-600 to-purple-600 rounded-xl shadow-lg p-6 text-white">
                ...
                <ul class="space-y-3 text-sm">
                    ...
                    <li class="flex items-start">
                        <i class="fas fa-check-circle mr-2 mt-1"></i>
                        <span>Genere el reporte en PDF</span>
                    </li>
                    <li class="flex items-start">
                        <i class="fas fa-check-circle mr-2 mt-1"></i>
                        <span>Descargue o imprima</span>
                    </li>
                </ul>
            </div>
        </div>
